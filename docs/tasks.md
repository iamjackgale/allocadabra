...
| 092 | DONE | Backend/Data Agent | Implement deterministic configuration validation for unsupported model IDs and impossible constraint combinations, with stable field-specific issue codes for the Frontend Configuration flow. | 2026-04-24 07:29:06 BST |
...
| 097 | DONE | Orchestrator Agent | Create an AI live integration spec covering Configuration Mode, Review Mode, guardrails, context injection, live-provider verification, and prompt-quality review. | 2026-04-24 13:41:50 BST |
...
| 129 | DONE | QA/Validation Agent | Convert AI live and fixture checks into repeatable validation coverage for missing-key handling, guardrail intercepts, metadata shape, and context selection. Script at `scripts/ai_smoke_extended.py`. | 2026-04-25 BST |
| 130 | DONE | Frontend Agent | Replace deprecated Streamlit `use_container_width` usage with `width="stretch"/"content"` across all four frontend files. 36 usages fixed; no warnings in Streamlit 1.56.0. | 2026-04-25 BST |
